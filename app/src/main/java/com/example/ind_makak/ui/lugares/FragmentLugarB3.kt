...
class FragmentLugarB3 : Fragment() {
    ...
    override fun onCreateView(
       ...
       _binding = FragmentLugarB3Binding.inflate(inflater, container, false)
        ...
        binding.buttonFragLugarB3Regis.setOnClickListener{
            lifecycleScope.launch {
                try {
                    val nombre = binding.inputTextEditFragB3Nom.text.toString()
                    val correo = binding.inputTextEditFragB3Correo.text.toString()
                    val noServPub = binding.inputNumbFragB3NoServPub.text.toString()
