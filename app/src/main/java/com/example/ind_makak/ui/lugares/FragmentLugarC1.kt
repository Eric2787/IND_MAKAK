    ...
    override fun onCreateView(
        ...
        binding.buttonFragLugarC1Regis.setOnClickListener{
            lifecycleScope.launch {
                try {
                    val nombre = binding.inputTextEditFragC1Nom.text.toString()
                    val correo = binding.inputTextEditFragC1Correo.text.toString()
                    val noServPub = binding.inputNumbFragC1NoServPub.text.toString()
